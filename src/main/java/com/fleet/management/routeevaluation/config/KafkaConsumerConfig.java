...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ReceiverOptions<String, TrackingDetails> kafkaReceiverOptions(@Value(value = "${fleet.route-evaluation.consumer.topic.tracking-topic}") String topic, KafkaProperties kafkaProperties) {
